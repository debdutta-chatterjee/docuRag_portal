...
from exception.custom_exception import DocuRAGException
...
class ApiKeyManager:
    ...
    def __init__(self):
        ...
        if missing:
            ...
            raise DocuRAGException("Missing API keys", sys)
...
class ModelLoader:
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            raise DocuRAGException("Failed to load embedding model", sys)
